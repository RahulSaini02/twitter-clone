  ...
  return (
    <div className='col-span-7 lg:col-span-5 border-x max-h-screen overflow-scroll scrollbar-hide'>
        <div className='flex justify-between items-center'>
            <h1 className='p-5 font-bold text-xl pb-0'>Home</h1>
            <RefreshIcon onClick={handleRefresh} className='mr-5 mt-5 h-8 w-8 cursor-pointer text-twitter transition-all duration-300 ease-out hover:rotate-180 active:scale-125' />
        </div>
        {/* Tweet Box */}
        <div>
